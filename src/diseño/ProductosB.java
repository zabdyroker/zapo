    ...
    public ProductosB() {
      ...
      String comparar(String cod){
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM cat_productos WHERE id_producto='"+cod+"'");
            while(rs.next())
            {
                cant=rs.getString(4);
            }
     ...
     //"Precio","peso unitario","peso en venta","id departamento","cantidad minima","iva","peso U en mayoreo","peso S en mayoreo"   
        tabla=new DefaultTableModel(null,Titulo);
    String []Registro= new String[4];
    String mostrar="SELECT * FROM cat_productos WHERE CONCAT (id_producto,'',desc_producto) LIKE '%"+dato+"%'"; 
    Statement st;
        try {
