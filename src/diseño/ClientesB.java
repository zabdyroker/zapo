...
DefaultTableModel modelo;
    ...
    {
        String[]titulos={"Codigo","Nombres","Apellido Paterno","Apellido Materno","RFC","Razon social","tipo"} ;  
        String []Registros= new String[7];
        modelo=new DefaultTableModel(null,titulos);
        String Sql="SELECT * FROM cat_cliente WHERE CONCAT(idcat_cliente,paterno,materno,nombre,RFC,tipo,razon_social) LIKE '%"+valor+"%'";
...
// TODO add your handling code here:
    try {
        ...
        Administrador.jLabel1.add(ingcli);
        ingcli.toFront();
...
// TODO add your handling code here:
     String cod="",nom="",apePA="",apeMA="",RFc="",razonSocial="",tiPo="";
    ...
    try {
        ...
        else
        {
         ...
         apePA=  (String)tbclientes.getValueAt(fila, 1);
         apeMA=  (String)tbclientes.getValueAt(fila, 2);
         nom =  (String)tbclientes.getValueAt(fila, 3);
         RFc =  (String)tbclientes.getValueAt(fila, 4);
         razonSocial=  (String)tbclientes.getValueAt(fila, 5);
         tiPo=  (String)tbclientes.getValueAt(fila, 6);
         
         Boleta.txtcod.setText(cod);
         Boleta.txtnomape.setText(nom+"   "+apePA+"   "+apeMA);
         Boleta.txtdire.setText(RFc);
         Boleta.txtdni.setText(razonSocial);
